  ...
  mk: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Авионски транспорт", desc: "Брз и сигурен транспорт за итни пратки преку меѓународни авионски линии." },
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "Air freight", desc: "Fast and reliable transport for urgent shipments through international air routes." },
